...
//Data from the JSON file is stored here
  const [Saturn] = useState<any>(Data.Saturn);
  const [value, setValue] = useState<number>(0);

  const { name, overview, content, source, structure, geology, rotation, revolution, radius, temperature, images, planet, internal } = Saturn[value];
